...
const LOGIN_API_URL = 'https://godel-lottery.herokuapp.com/api/login';
const LOGOUT_API_URL = 'https://godel-lottery.herokuapp.com/api/logout';
const APPLICATION_API_URL = 'https://godel-lottery.herokuapp.com/api';
